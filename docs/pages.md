...
![Page Settings](img/vc-page-settings.png)
...
![Page Options](img/page-options.png)
...
![Choose template teaser](img/select-template-teaser.png)
...
![Steps to configure 404 Not Found page](img/set-404-page.png)
